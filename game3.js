...
function setGame() {
    ...
    setInterval(setPlant, 2000); // 2000 milliseconds = 2 seconds, every 2 second call setPlant
}
...
// Make sure the board is emptied and tiles are cleared when game starts
